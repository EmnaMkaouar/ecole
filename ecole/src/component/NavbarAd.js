...
componentDidMount() {
  ...
  <li><a href="#!" className="center">Login</a></li>
    ...
    <a href="#" data-target="slide-out" className="sidenav-trigger  show-on-large"><i className="material-icons menu">menu</i></a>
    <Link to="/" className="brand-logo center black-text navbar-close">المدرسة الابتدائية</Link>
  ...
  <ul id="slide-out" className="sidenav">
    <li><div className="user-view">
      ...
      <a href="#user"><img className="circle" src={admin}/> </a>
    ...
    <li><div className="divider"></div></li>
    <li><a className="waves-effect" href="#!"><i className="material-icons">people</i>تعيين المدرّسين</a></li>
    <li><div className="divider"></div></li>
    <li><Link className="waves-effect sidenav-close" to='/M'><i className="material-icons">edit</i>التّصرّف في المواد</Link></li>
    <li><div className="divider"></div></li>
    <li><a className="waves-effect" href="#!"><i className="material-icons">edit</i>التصرّف في الأقسام</a></li>
    <li><div className="divider"></div></li>
